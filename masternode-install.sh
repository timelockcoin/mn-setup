...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='timelockcoin.conf'
CONFIGFOLDER='/root/.timelockcoin'
COIN_DAEMON='timelockcoind'
COIN_CLI='timelockcoin-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/timelockcoin/tym/releases/download/1.0.0/timelockcoin-1.0.0-linux.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='timelockcoind'
COIN_EXPLORER='http://tymexplorer.timelock.net'
COIN_PORT=4402
RPC_PORT=4401
